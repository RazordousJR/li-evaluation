...
function calcSummary() { document.getElementById("s_nama").textContent = document.getElementById("nama_pelajar").value || "\u2014"; document.getElementById("s_matrik").textContent = document.getElementById("no_matrik").value || "\u2014"; document.getElementById("s_kursus").textContent = document.getElementById("kursus").value || "\u2014"; document.getElementById("s_sesi").textContent = document.getElementById("sesi").value + " Sem " + document.getElementById("semester").value; document.getElementById("s_svf").textContent = document.getElementById("svf_name").value || "\u2014"; document.getElementById("s_svi").textContent = document.getElementById("svi_name").value || "\u2014"; document.getElementById("s_org").textContent = document.getElementById("organisasi").value || "\u2014"; document.getElementById("s_svi_rating").textContent = document.getElementById("svi_rating").value || "\u2014"; document.getElementById("s_svf_rating").textContent = document.getElementById("svf_rating").value || "\u2014"; document.getElementById("s_svf_status").textContent = document.getElementById("svf_status").value || "\u2014"; var sviA = v("svi_a1") + v("svi_a2") + v("svi_a3") + v("svi_a4"); var sviB = v("svi_b1") + v("svi_b2") + v("svi_b3") + v("svi_b4") + v("svi_b5") + v("svi_b6") + v("svi_b7") + v("svi_b8") + v("svi_b9") + v("svi_b10"); var svfA = v("svf_a1_admin") + v("svf_a1_tech") + v("svf_a2_admin") + v("svf_a2_tech") + v("svf_a3"); var logT = v("log_a1") + v("log_b1") + v("log_c1"); var psvfT = v("psvf_a") + v("psvf_b1") + v("psvf_b2") + v("psvf_b3") + v("psvf_b4") + v("psvf_b5") + v("psvf_c1") + v("psvf_c2") + v("psvf_c3") + v("psvf_d1") + v("psvf_d2") + v("psvf_d3") + v("psvf_d4"); var psviT = v("psvi_a") + v("psvi_b1") + v("psvi_b2") + v("psvi_b3") + v("psvi_b4") + v("psvi_b5") + v("psvi_c1") + v("psvi_c2") + v("psvi_c3") + v("psvi_d1") + v("psvi_d2") + v("psvi_d3") + v("psvi_d4"); var a4rep = pilihan === 1 ? (v("rep_a4_tech_p1") + v("rep_a4_admin_p1")) : (v("rep_a4_tech_p2") + v("rep_a4_admin_p2")); var repA = v("rep_a1") + v("rep_a2") + v("rep_a3") + a4rep + v("rep_a5") + v("rep_a6") + v("rep_a7"); var repB = v("rep_b1") + v("rep_b2") + v("rep_b3") + v("rep_b4"); var repT = repA + repB; document.getElementById("sum_svi_a").textContent = sviA; document.getElementById("sum_svi_b").textContent = sviB; document.getElementById("sum_svf_a").textContent = svfA; document.getElementById("sum_log").textContent = logT; document.getElementById("sum_rep").textContent = repT; document.getElementById("sum_psvf").textContent = psvfT; document.getElementById("sum_psvi").textContent = psviT; document.getElementById("sum_soft").textContent = sviB; var sviA1 = v("svi_a1"); var sviA23 = v("svi_a2") + v("svi_a3") + v("svi_a4"); var svfA1 = v("svf_a1_admin") + v("svf_a1_tech"); var svfA23 = v("svf_a2_admin") + v("svf_a2_tech") + v("svf_a3"); var prj1 = fmt(sviA1 / 10 * 15); var prj2 = fmt(sviA23 / 40 * 15); var prj3 = fmt(svfA1 / 30 * 15); var prj4 = fmt(svfA23 / 60 * 15); var lr1 = fmt(logT / 70 * 20); var pr11 = fmt(sviB / 50 * 20); var b3926 = fmt(prj1 + prj2 + prj3 + prj4 + lr1 + pr11); document.getElementById("r_prj1r").textContent = sviA1; document.getElementById("r_prj1").textContent = prj1; document.getElementById("r_prj2r").textContent = sviA23; document.getElementById("r_prj2").textContent = prj2; document.getElementById("r_prj3r").textContent = svfA1; document.getElementById("r_prj3").textContent = prj3; document.getElementById("r_prj4r").textContent = svfA23; document.getElementById("r_prj4").textContent = prj4; document.getElementById("r_lr1r").textContent = logT; document.getElementById("r_lr1").textContent = lr1; document.getElementById("r_pr11r").textContent = sviB; document.getElementById("r_pr11").textContent = pr11; document.getElementById("sum_3926_total").textContent = b3926; var g1 = getGrade(b3926); var gb1 = document.getElementById("sum_3926_grade"); gb1.textContent = g1.g; gb1.className = "grade-pill " + g1.cls; var tr1_lapa = fmt(repA / 2); var tr1_lapb = fmt(repB / 40 * 10); var tr1_svfc = v("svf_c1"); var tr1_logc = v("log_c1"); var tr1 = fmt(tr1_lapa + tr1_lapb + tr1_svfc + tr1_logc); var pr11b_svfb = v("svf_b1"); var pr11b_svib = fmt(sviB / 5); var pr11b = fmt(pr11b_svfb + pr11b_svib); var pr12 = fmt(sviB / 50 * 10); var b3946 = fmt(tr1 + pr11b + pr12); document.getElementById("r2_tr1_lapa_raw").textContent = repA; document.getElementById("r2_tr1_lapa").textContent = tr1_lapa + " / 40"; document.getElementById("r2_tr1_lapb_raw").textContent = repB; document.getElementById("r2_tr1_lapb").textContent = tr1_lapb + " / 10"; document.getElementById("r2_tr1_svfc_raw").textContent = tr1_svfc; document.getElementById("r2_tr1_svfc").textContent = tr1_svfc + " / 10"; document.getElementById("r2_tr1_logc_raw").textContent = tr1_logc; document.getElementById("r2_tr1_logc").textContent = tr1_logc + " / 10"; document.getElementById("r2_tr1").textContent = tr1 + " / 70"; document.getElementById("r2_pr11_svfb_raw").textContent = pr11b_svfb; document.getElementById("r2_pr11_svfb").textContent = pr11b_svfb + " / 10"; document.getElementById("r2_pr11_svib_raw").textContent = sviB; document.getElementById("r2_pr11_svib").textContent = pr11b_svib + " / 10"; document.getElementById("r2_pr11").textContent = pr11b + " / 20"; document.getElementById("r2_pr12r").textContent = sviB; document.getElementById("r2_pr12").textContent = pr12; document.getElementById("sum_3946_total").textContent = b3946; var g2 = getGrade(b3946); var gb2 = document.getElementById("sum_3946_grade"); gb2.textContent = g2.g; gb2.className = "grade-pill " + g2.cls; }
